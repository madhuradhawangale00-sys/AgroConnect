...
export default function ContractDetailPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 bg-[url('/resources/background2.jpeg')] bg-cover bg-center opacity-15 print:hidden" />
      <div className="fixed inset-0 -z-10 bg-gradient-to-b from-slate-950/80 via-slate-950/90 to-slate-950 print:hidden" />
      <Header />
